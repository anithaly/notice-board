...
namespace Noticeboard\PublicationBundle\Controller;
...
use Noticeboard\PublicationBundle\Entity\Publication;
use Noticeboard\PublicationBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NoticeboardPublicationBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("NoticeboardPublicationBundle:Publication:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NoticeboardPublicationBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NoticeboardPublicationBundle:Publication:edit.html.twig")
     */
